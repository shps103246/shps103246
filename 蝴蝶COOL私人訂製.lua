...
local var_0_65 = {
	build = "stable",
	level = 0,
	user = _USER_NAME or var_0_2 and "yanqt" or "yanqt",
	script = _SCRIPT_NAME or var_0_2 and "hysteria • debug" or "yanqt • beta",
	version = var_0_1
}
local var_0_66 = {
	hysteria = {
...
LPH_NO_VIRTUALIZE(function()
	...
	var_282_14.logs.preview, var_282_14.logs.dummy = false, {
		...
		{
			text = "\aA67CCF\x01•\aE6E6E6\x02 Missed\aE6E6E6\x02 \aE6E6E6\x01YANQT\aE6E6E6\x02's\aE6E6E6\x01 head\aE6E6E6\x02 due to \aE6E6E6\x01unpredicted occasion",
			event = "miss",
			time = var_0_31.huge,
			progress = {
				0
		...
		{
			text = "\ad35050\x01•\aE6E6E6\x02 Harmed by\aE6E6E6\x02 \aE6E6E6\x01yanQt\aE6E6E6\x02 in \aE6E6E6\x01head\aE6E6E6\x02 for \aE6E6E6\x0172",
			event = "harm",
			time = var_0_31.huge,
			progress = {
				0
